...
QT_MOC_LITERAL(8, 87, 13)
    ...
    "Gui_Messages\0modified\0\0viewInMailBody\0"
    "viewOutMailBody\0sendMail\0refreshMessages\0"
    "delMenu\0deleteMessage\0"
};
...
void Gui_Messages::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->delMenu((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Gui_Messages::modified)) {
                *result = 0;
            }
        }
    }

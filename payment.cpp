...
Payment::Payment(const Payment& pay) : _requester(pay._requester->clone()), _approvation(pay._approvation), _sub(pay._sub->clone()), _bmethod(pay._bmethod->clone()), _appdate(pay._appdate) {}

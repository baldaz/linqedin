...
QT_MOC_LITERAL(2, 27, 0)
    ...
    "MessageModel\0editCompleted\0\0"
};
...
void MessageModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MessageModel::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MessageModel::editCompleted)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MessageModel::editCompleted(const QString & _t1)
{
